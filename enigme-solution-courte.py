...
prod = ( boys [ 0 ][ 2 ] + 1 ) ** 2
print "L'aîné des garçons a donc", boys [ 0 ][ 2 ], "ans. Le produit de l'âge des filles est donc:", prod
...
# print "les âges des garçons sont: ", boys, "l'ainé est agé de", boys [ 0 ][ 2 ], "ans."
# prod = ( boys [ 0 ][ 2 ] + 1 ) ** 2
